...
public class Money implements Comparable {
	...
	public Boolean equals(Money other) {
        return this.getAmount().equals(other.getCurrency().valueInThisCurrency(other.amount, this.currency));
	}
	...
	public Money add(Money other) {
        int otherInMyCurrency = this.getCurrency().valueInThisCurrency(other.getAmount(), other.currency);

        return new Money(this.amount +otherInMyCurrency, this.currency);
	}
	...
	public int compareTo(Object other) {
		if (other instanceof Money) {
			return this.getCurrency().universalValue(this.getAmount()).compareTo(((Money) other).getCurrency().universalValue(((Money) other).getAmount()));
		}
		return -100;
	}
}